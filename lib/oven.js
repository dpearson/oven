...
(function() {
  var bindir, build, clc, clean, cmd, coffee, coffeelint, coffeelintConfig, fileIs, fs, genCpyFunc, genList, lint, loc, ovenfile, ovenfilePath, pkg, runCmd, runSilent, srcdir, watch, _ref;
  ...
  if (cmd === "build" || cmd === "watch" || cmd === "clean" || cmd === "lint" || cmd === "loc") {
